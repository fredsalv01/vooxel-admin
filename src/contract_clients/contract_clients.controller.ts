...
export class ContractClientsController {
  constructor(private readonly contractClientsService: ContractClientsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateContractClientDto: UpdateContractClientDto) {
